...
function FrontEnd() {
  ...
  return (
    <>
      <div
        id="frontEnd"
        className="container frontEnd d-flex flex-column align-items-end align-items-center"
      >
        <div
          className={`${theme}-mode-text littleScreen frontEnd-text d-flex flex-column justify-content-around col-md-6`}
        >
          <div>
          ...
          <div>
            <h2 className={`${theme}-mode-text `}>Desenvolvimento Front-End</h2>
            <p>
            ...
            <p>
              ...
              trabalho. Torna tudo mais divertido ♥
            </p>
          </div>
        </div>
        <div
        ...
        >
          <div id="skills">
            ...
            <div className="d-flex flex-row justify-content-around  ">
              <img className="frontEnd-icon" src={github} alt="ícone github" />
              <img className="frontEnd-icon" src={html} alt="ícone html" />
              <img className="frontEnd-icon" src={css} alt="ícone css" />
              <img
                className="frontEnd-icon"
                src={bootstrap}
                alt="ícone bootstrap"
              />
              <img className="frontEnd-icon" src={figma} alt="ícone figma" />
            </div>
          </div>
        </div>
      </div>
