    ...
    return (
        <>
            <div id="frontEnd" className="container frontEnd d-flex flex-column align-items-end align-items-center">
                <div className={`${theme}-mode-text littleScreen frontEnd-text d-flex flex-column justify-content-around col-md-6`}>
                    <div>
                ...
                <div className={`${theme}-techniques d-flex flex-column col-md-6 text-center justify-content-around col-md-6 `}>
                    <div id="skills">
